							...
							<div class="row">
								<div class="col-md-4">
									...
									<div class="title-widget-bg">
										<div class="title-widget">İnstagram'dan Takip Et !</div>
									</div>
									<ul class="tweets">
									...
									<a href="#" class="btn btn-default btn-follow"><i class="fa fa-instagram fa-2x"></i>
										<div>Takip Et İnstagram</div>
									</a>
								</div>
								<!--footer twitter widget-->
								<div class="col-md-4">
									...
									<div class="newsletter">
										...
										<form role="form">
											<div class="form-group">
												...
												<input type="email" class="form-control newstler-input"
													id="exampleInputEmail1" placeholder="Enter email">
												<button class="btn btn-default btn-red btn-sm">Yakında aktif
													olacak</button>
											</div>
										</form>
									</div>
					...
					<div class="footer">
						...
						<div class="container">
							<div class="row">
								<div class="col-md-9">
									<hr>
									<div class="f-credit">&copy;Tüm haklar <a href="#">Fenomen Barbes Club.com <span>
												saklıdır.</span></a></div>
									<a href="">
